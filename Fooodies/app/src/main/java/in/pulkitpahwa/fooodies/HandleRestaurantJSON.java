...
public class HandleRestaurantJSON {
    private List<String> name  = new ArrayList<String>();
    private List<Boolean> nv  = new ArrayList<Boolean>();
    private List<Boolean> hd  = new ArrayList<Boolean>();
    ...
    public HandleRestaurantJSON(String  url)
    {
        this.urlString = url;
    }
