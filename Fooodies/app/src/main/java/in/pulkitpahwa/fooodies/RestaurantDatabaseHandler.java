...
public class RestaurantDatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "restaurantbasketManager";

    // Contacts table name
    private static final String TABLE_BASKET = "restaurantbasketdb";
...
//        values.put(BASKET_ID,mCursor.getColumnIndex("id") + 1);
    ...
    //  Log.w("myapp",Integer.toString(mCursor.getColumnIndex("id") ));
        List<MyRestaurantCart> m = getAllBaskets();
    ...
    MyRestaurantCart getBasket(int id) {
...
//              Double tax, Double total)
        ...
        MyRestaurantCart mycart = new MyRestaurantCart(Integer.parseInt(cursor.getString(0)),
    ...
    // Getting All Basket
    public List<MyRestaurantCart> getAllBaskets() {
        List<MyRestaurantCart> basketList = new ArrayList<MyRestaurantCart>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                ...
                MyRestaurantCart mycart = new MyRestaurantCart();
