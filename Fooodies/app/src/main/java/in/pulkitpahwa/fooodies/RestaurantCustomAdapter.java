...
class RestaurantCustomAdapter extends ArrayAdapter
{
    ...
    RestaurantCustomAdapter(Context context,List<String> names, List<String> nv, List<String> hd, List<String> ot, List<String> ct, List<Integer> fid ) {
